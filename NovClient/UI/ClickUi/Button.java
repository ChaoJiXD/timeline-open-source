...
public class Button {
	...
	public void render(int mouseX, int mouseY) {
		...
		Gui.drawRect(this.x - 5, this.y - 5, this.x + 85, this.y + font.getStringHeight(this.cheat.getName()) + 3.8,
		...
		if (this.cheat.isEnabled()) {
			...
			font.drawString(Client.getModuleName(cheat), this.x, this.y, new Color(47, 154, 241).getRGB(),255);
		} else {
			font.drawString(Client.getModuleName(cheat), this.x, this.y, new Color(108, 108, 108).getRGB(),255);
		}
