 ...
 * @author CCBlueX
 */
public final class LiuqidRender {
    ...
    public static void renderNameTag(final String string, final double x, final double y, final double z) {
        ...
        final int width = Client.instance.FontLoaders.Chinese35.getStringWidth(string) / 2;

        Gui.drawRect(-width - 1, -1, width + 1, 17.5, Integer.MIN_VALUE);
        Client.instance.FontLoaders.Chinese35.drawStringWithShadow(string, -width, 1.5F, Color.WHITE.getRGB(),255);
    ...
    public static void resetCaps() {
        glCapMap.forEach(LiuqidRender::setGlState);
    }
