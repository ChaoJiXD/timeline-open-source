...
/**
 * Created by MiLiBlue on 2022/4/29 18:42
 */
public class BowLongJump extends Module {
    ...
    public BowLongJump() {
        super("TestFly", new String[]{}, ModuleType.Move);
    }
    ...
    public void onEnable() {
        ...
        if (!mc.thePlayer.inventory.hasItem(Items.arrow)) {
            Helper.sendMessage("Did not find arrows in your hotbar.");
            setEnabled(false);
            return;
        }
        ...
        if (i == 9) {
            Helper.sendMessage("Did not find a bow in your hotbar.");
            setEnabled(false);
            return;
        } else {
    ...
    @EventHandler
    public void onFly(EventPreUpdate e) {
