...
import NovClient.API.Events.Misc.EventLivingUpdate;
...
import NovClient.Util.Particles;
...
public class DMGParticle extends Module {
	...
	public DMGParticle() {
		super("ShowDMG", new String[] { "Damage Particle" }, ModuleType.Render);
	}
	...
	public void onRender(EventRender3D e) {
		for (Particles p : this.particles) {
			...
			this.font1.drawStringWithShadow(p.text,
					(float) (-(this.font1.getStringWidth(p.text) / 2)),
					(float) (-(this.font1.FONT_HEIGHT - 1)), 0,255);
