...
//				Client.instance.notes.add(new Note("Module", name + "Enabled.", Type.Warming));
		} else {
			EventBus.getInstance().unregister(new Object[] { this });
	//			Client.instance.notes.add(new Note("Module", name + "Disabled.", Type.Warming));
			this.onDisable();
		}
