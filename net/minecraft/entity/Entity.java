...
import NovClient.API.Events.World.EventStrafe;
import NovClient.Module.Modules.Legit.HitBox;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || i3.isEnabled() && this instanceof EntityPlayer;;
            if(i3.isEnabled() && i3.safe.getValue() && Minecraft.getMinecraft().gameSettings.keyBindSprint.isKeyDown()) {
                flag = false;
            }

            if(i3.isEnabled() && i3.safe.getValue() == false) {
                flag = false;
            }
            if (flag)
            {
