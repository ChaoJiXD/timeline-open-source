...
import NovClient.Module.Modules.Misc.NoCommand;
import NovClient.Module.Modules.Move.NoSlow;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
		...
		EventBus.getInstance().register(rotate);
		this.posX = oldX;
		this.posZ = oldZ;
    ...
    public void sendChatMessage(String message) {
		if (message.startsWith(".") && !Client.instance.getModuleManager().getModuleByClass(NoCommand.class).isEnabled()) {
    ...
    public void onLivingUpdate()
    {
		...
		if (this.isUsingItem() && !this.isRiding()) {
			double speed = ns.isEnabled() ? ns.Speed.getValue() : 0.2D;
			if(ns.Ground.getValue() && Minecraft.getMinecraft().thePlayer.onGround == false)
			{
				speed = 0.2;
			}
