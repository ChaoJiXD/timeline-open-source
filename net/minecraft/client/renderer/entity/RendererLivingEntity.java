...
import NovClient.Module.Modules.Misc.AntiAim;
import NovClient.Module.Modules.Move.Scaffold;
import NovClient.Module.Modules.Render.Chams;
import NovClient.Module.Modules.Render.ESP;
import NovClient.Module.Modules.Render.NameTags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, x, y, z))
        {
            ...
            try
            {
                ...
                float f7 = (entity == Minecraft.getMinecraft().thePlayer && (KillAura.blockTarget != null
						&& Client.instance.getModuleManager().getModuleByClass(KillAura.class).isEnabled() || Client.instance.getModuleManager().getModuleByClass(Scaffold.class).isEnabled()|| Client.instance.getModuleManager().getModuleByClass(AntiAim.class).isEnabled() || Client.instance.getModuleManager().getModuleByClass(Speed.class).isEnabled()))
						? Client.Pitch
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
    	...
    	boolean eb = outline.isEnabled() && outline.invis.getValue();
