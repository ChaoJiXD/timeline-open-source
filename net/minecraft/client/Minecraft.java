...
//                        System.gc();
 ...
 //       this.initStream();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft 1.8.9 | Loading.");
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
            	inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("NovAssets/ICON/LaunchIcon.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("NovAssets/ICON/LaunchIcon.png"));
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        GlStateManager.enableTexture2D();
        InputStream inputstream = null;
        RenderUtil.drawImage(new ResourceLocation("NovAssets/BACKGROUND/LaunchBackground.png"), 0, 0, new ScaledResolution(this).getScaledWidth(), new ScaledResolution(this).getScaledHeight());
