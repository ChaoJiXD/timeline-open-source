...
public class GuiChat extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (inputField.getText().startsWith(".")) {
			font.drawString("CMD", 4f+24f-12f-font.getStringWidth("CMD")/2, this.height - 10, new Color(47, 154, 241).getRGB(),255);
		} else if (inputField.getText().startsWith("/")) {
			font.drawString("CMD", 4f+24f-12f-font.getStringWidth("CMD")/2, this.height - 10, new Color(47, 154, 241).getRGB(),255);
		} else {
			font.drawString("CHAT", 4f+24f-12f-font.getStringWidth("CHAT")/2, this.height - 10, new Color(47, 154, 241).getRGB(),255);
		}
