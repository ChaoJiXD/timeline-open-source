            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if(!HUD.FastChat.getValue())drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
                ...
                if (flag)
                {
                    ...
                    if (l2 != i3)
                    {
                        ...
                        if(!HUD.FastChat.getValue())drawRect(0, -j3, 2, -j3 - k1, l3 + (k3 << 24));
                        if(!HUD.FastChat.getValue())drawRect(2, -j3, 1, -j3 - k1, 13421772 + (k3 << 24));
                    }
                }
